...
public class KeyboardButtonUtilEn {
    ...
    public static ReplyKeyboardMarkup asosiyMenuEn() {
        KeyboardButton button = KeyboardButtonUtil.buttonEmoji("Ordering", ":taxi:");
        KeyboardButton button1 = KeyboardButtonUtil.buttonEmoji("Stock", ":fire:");
        KeyboardButton button2 = KeyboardButtonUtil.buttonEmoji("about Us", ":information_source:");
        KeyboardButton button3 = KeyboardButtonUtil.buttonEmoji("Contact us", ":telephone_receiver:");
        KeyboardButton button4 = KeyboardButtonUtil.buttonEmoji("Settings", ":wrench:");
        KeyboardButton button5 = KeyboardButtonUtil.buttonEmoji("My addresses", ":house:");
    ...
    public static ReplyKeyboardMarkup MaxWayMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", ":arrow_left:");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup komboMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup choiseNumMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
    ...
    public static ReplyKeyboardMarkup klabMenuEn(User user) {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup burgerMenuEn(User user) {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup donarMenuEn(User user) {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup lavashMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup shourmaMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup snekMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup xotDogMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup garnirMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup napitkiMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup desertMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup snekiiEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup sousiMenuEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Shopping", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup savatEn() {
        KeyboardButton tozalash = KeyboardButtonUtil.buttonEmoji("Cleaning", "♻️");
        KeyboardButton buyurtma_berish = KeyboardButtonUtil.buttonEmoji("Ordering", "\uD83D\uDE98");
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
    ...
    public static ReplyKeyboardMarkup locationEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
    ...
    public static ReplyKeyboardMarkup contactEn() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", "◀️");
    ...
    public static ReplyKeyboardMarkup menuLenguageEn(){
    ...
    public static ReplyKeyboardMarkup nastroykaMenuEn(){
        KeyboardButton language = KeyboardButtonUtil.buttonEmoji("Change the language", "\uD83D\uDD04");
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Back", ":arrow_left:");
