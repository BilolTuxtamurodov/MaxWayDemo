...
public class KeyboardButtonUtilRu {
    ...
    public static ReplyKeyboardMarkup asosiyMenuRu() {
        KeyboardButton button = KeyboardButtonUtil.buttonEmoji("Заказ", ":taxi:");
        KeyboardButton button1 = KeyboardButtonUtil.buttonEmoji("Акция", ":fire:");
        KeyboardButton button2 = KeyboardButtonUtil.buttonEmoji("О нас", ":information_source:");
        KeyboardButton button3 = KeyboardButtonUtil.buttonEmoji("Связаться с нами", ":telephone_receiver:");
        KeyboardButton button4 = KeyboardButtonUtil.buttonEmoji("Настройки", ":wrench:");
        KeyboardButton button5 = KeyboardButtonUtil.buttonEmoji("Мои адреса", ":house:");
    ...
    public static ReplyKeyboardMarkup MaxWayMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", ":arrow_left:");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup komboMenuRu() {
    ...
    public static ReplyKeyboardMarkup choiseNumMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
    ...
    public static ReplyKeyboardMarkup klabMenuRu(User user) {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup burgerMenuRu(User user) {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup donarMenuRu(User user) {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup lavashMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup shourmaMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup snekMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup xotDogMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup garnirMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup napitkiMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup desertMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup snekiiRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup sousiMenuRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton savat = KeyboardButtonUtil.buttonEmoji("Корзина", ":inbox_tray:");
    ...
    public static ReplyKeyboardMarkup savatRu() {
        KeyboardButton tozalash = KeyboardButtonUtil.buttonEmoji("Очистить", "♻️");
        KeyboardButton buyurtma_berish = KeyboardButtonUtil.buttonEmoji("Заказ", "\uD83D\uDE98");
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
    ...
    public static ReplyKeyboardMarkup locationRu() {
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", "◀️");
        KeyboardButton location = KeyboardButtonUtil.buttonEmoji("Место нахождения", "\uD83D\uDCCD");
    ...
    public static ReplyKeyboardMarkup menuLenguageRu(){
    ...
    public static ReplyKeyboardMarkup nastroykaMenuRu(){
        KeyboardButton language = KeyboardButtonUtil.buttonEmoji("Изменить язык", "\uD83D\uDD04");
        KeyboardButton orqaga = KeyboardButtonUtil.buttonEmoji("Назад", ":arrow_left:");
