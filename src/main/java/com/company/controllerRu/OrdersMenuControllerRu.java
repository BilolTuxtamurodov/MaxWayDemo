...
public class OrdersMenuControllerRu {
    public void equalRu(User user, Message message) {
        ...
        switch (text) {
            ...
            case "Lavash Kurinnniy Big c Sirom" -> {
            ...
            case "Mini Lavash Kurinniy s Sirom" -> {
            ...
            case "Shaurma Kurinniy Sirli Mini" -> {
            ...
            case "Salat is Krasniy Kapustiy" -> {
